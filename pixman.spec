...
Source0  : http://cairographics.org/releases/pixman-0.36.0.tar.gz
...
%prep
%setup -q -n pixman-0.36.0
%patch1 -p1
pushd ..
cp -a pixman-0.36.0 build32
popd
pushd ..
cp -a pixman-0.36.0 buildavx2
popd
pushd ..
cp -a pixman-0.36.0 buildavx512
popd
...
export LANG=C
export SOURCE_DATE_EPOCH=1542841935
...
/usr/lib64/haswell/avx512_1/libpixman-1.so.0.36.0
/usr/lib64/haswell/libpixman-1.so.0
/usr/lib64/haswell/libpixman-1.so.0.36.0
/usr/lib64/libpixman-1.so.0
/usr/lib64/libpixman-1.so.0.36.0

%files lib32
%defattr(-,root,root,-)
/usr/lib32/libpixman-1.so.0
/usr/lib32/libpixman-1.so.0.36.0
